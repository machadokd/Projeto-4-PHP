...
function calc2() {
  ...
  if(idade < 40 || idade > 65){
    ...
    if (sexo !== "" && idade !== "" && fumador !== "" && pas !== "" && colesterol_total !== "") {
      ...
      $("#descricao_score").empty();
      $("#descricao_score").append('<p>O valor de '+ st6 +'% significa que a 10 anos, cerca de '+ st6 +' pessoas em cada 100 com este valor de risco, sofrerão uma doença cardiovascular fatal. Este risco foi calculado com base nos fatores idade, sexo, tabagismo, pressão arterial sistólica e colesterol total. Poderão existir outros fatores que aumentem este risco. </p>');
