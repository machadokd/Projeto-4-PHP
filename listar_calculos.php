...
<body>
    ...
    <main>
        <div>
            <a class="botoes" href="./admin/gerarExcel.php" target="_blank">Gerar relatório Excel</a>
            <a class="botoes" href="./admin/graficos.php">Ir para os gráficos</a>
            <a class="botoes" href="/admin/gerarPdf2.php" target="_blank">Gerar relatório em PDF</a>
            <a class="botoes" href="/admin/gerarCSV.php" target="_blank">Gerar relatório em CSV</a>
                ...
                <tbody>
                    ...
                    foreach ($items as $row) {
                        ...
                        if (!$row2 = mysqli_fetch_assoc($result2)) {
                            ...
                            echo "<td>" . $row["colestrol"] . " mg/dL</td>";
                            echo "<td>" . $row["colestrol_ldl"] . " mg/dL</td>";
                            echo "<td>" . $row["pas"] . " mmHg</td>";
